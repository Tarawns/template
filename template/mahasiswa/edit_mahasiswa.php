...
$nim = $_GET["nim"];
$mhs = read_mhs("SELECT * FROM t_mahasiswa WHERE nim = $nim")[0];
...
<body>
	...
	<div class="row-mhs" style="position: relative;top: 10px;left:10px;bottom:10px;box-shadow: 0px 1px 4px black;padding:20px;
	margin-bottom: 100pX">
	...
	<input class="form-input" type="hidden" name="nim" 
	value="<?= @$mhs["nim"];?>">	
		...
		<table cellspacing="0" cellpadding="20" style="width: 100%;">
			...
			<tr>
				...
				<tr>
					...
					<td>
						<input class="form-input" type="date" name="tgl_lahir" id="tgl_lahir" require value="<?= $mhs["tgl_lahir"]?>">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<select class="form-input-select" name="jenis_kelamin" id="jenis_kelamin">
							<option <?php if($mhs["jenis_kelamin"] == 'PILIH'){echo 'selected';} ?>> ---PILIH--- </option>
				...
				<tr>
					...
					<td>
						<input class="form-input" type="number" name="no_hp" id="no_hp" require value="<?= $mhs["no_hp"]?>">
					</td>
				</tr>
				<tr>
					<td>
