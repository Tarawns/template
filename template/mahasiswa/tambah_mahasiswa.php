	...
	margin-bottom: 100px;">
		...
		<form name="tambah_mhs" class="tambah_mhs" action="" method="POST">
			<table cellspacing="0" cellpadding="20" style="width: 100%;">
				...
				<tr>
					<td>
						<label for="nama_lengkap">NAMA LENGKAP :</label></td>
						<td>
					...
					<tr>
						...
						<td>
							<select class="form-input-select" name="jurusan" id="jurusan" require="">
								<option>--PILIH--</option>
					...
					<tr>
						...
						<td> 
							<input class="form-input" type="date" name="tgl_lahir" id="tgl_lahir">
						</td>
					</tr>
					<tr>
						<td><label for="jenis_kelamin">JENIS KELAMIN :</label></td>
						<td>
							<select class="form-input-select" name="jenis_kelamin" id="jenis_kelamin" require="">
								<option>--PILIH--</option>
					...
					<tr>
						...
						<td>
							<input class="form-input-area" name="alamat" id="alamat">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input class="form-input" type="email" name="email" id="email" require="">
						</td>
					</tr>
					<tr>
						<td align="left">
							<button type="submit" class="btn" name="btn-simpan">
								SIMPAN
							</button>
						</td>
						<td align="right">
							<button type="submit" class="btn" name="btn-batal"> 
								BATAL 
							</button>
						</td>
					</tr>
